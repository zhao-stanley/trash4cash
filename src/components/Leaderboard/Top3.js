    ...
    <>
      <div className="flex flex-row justify-center items-end max-w-full gap-2">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-[#C0C0C0] text-sm font-bold mt-1">
            {sPlace.username}
          </h2>
          <h2 className="text-[#C0C0C0] text-xs font-bold">
            ${sPlace.earned}
          </h2>
        </div>
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-[#FFD700] text-xl font-extrabold mt-2">
            {fPlace.username}
          </h2>
          <h2 className="text-[#FFD700] text-md font-extrabold">
            ${fPlace.earned}
          </h2>
        </div>
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-[#CD7F32] text-sm font-bold mt-1">
            {tPlace.username}
          </h2>
          <h2 className="text-[#CD7F32] text-xs font-bold">
          ${tPlace.earned}
          </h2>
        </div>
      </div>
